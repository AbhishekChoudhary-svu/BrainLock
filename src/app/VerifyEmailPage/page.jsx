    ...
    <div className="w-full max-w-md">
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <div className="text-center">
                  {timeLeft > 0 ? (
                    ...
                    <div className="text-sm text-red-600 dark:text-red-400">Verification code has expired</div>
                  )}
                </div>
              </div>
              ...
              <div className="text-center space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <Button variant="ghost" asChild className="w-full text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
      ...
      <div className="mt-6 text-center">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          ...
          <Link href="/support" className="text-blue-600 hover:underline dark:text-blue-400 dark:hover:text-blue-300">
            contact support
          </Link>
        </p>
      </div>
