...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    setProfileData({
      ...
      joinDate: context.user.createdAt
        ? context.user.createdAt.split("T")[0]
        : "",
  ...
  if (!profileData) {
    return (
      <div className="lg:p-8 text-center text-red-600">
        <Loading />
      </div>
    );
  }
    ...
    <div className="min-h-screen w-full dark:bg-slate-950 bg-gray-50">
      ...
      <header className="bg-white dark:bg-slate-950 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-40">
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Badge
              variant="secondary"
              className="text-sm dark:bg-slate-800 dark:text-gray-200"
            >
              Edit / View Profile
            </Badge>
          </div>
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm overflow-hidden">
          {/* Profile Header */}
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-8 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-6">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="text-white">
                ...
                <p className="text-blue-100 dark:text-blue-200 text-base sm:text-lg capitalize">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
              {!isEditing ? (
                <button
                  onClick={handleEdit}
                  className="flex items-center justify-center px-4 py-2 bg-gradient-to-l from-blue-600 to-purple-600  text-white font-bold rounded-lg hover:from-blue-700 hover:to-purple-700 transition-colors"
                >
