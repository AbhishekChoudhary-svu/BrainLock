...
if (!profileData) {
  ...
  return (
   <div className="min-h-screen w-full dark:bg-slate-950 bg-gray-50">
  {/* Header */}
  <header className="bg-white dark:bg-slate-950 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-40">
      ...
      <div className="flex justify-between items-center h-16">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">Profile Dashboard</p>
          </div>
        </Link>
        <Badge variant="secondary" className="text-sm dark:bg-slate-800 dark:text-gray-200">
          Edit / View Profile
        </Badge>
      </div>
    </div>
    ...
    <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-8 flex justify-between items-center">
        <div className="flex items-center space-x-6">
          <div className="h-24 w-24 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center">
            <User className="h-12 w-12 text-gray-600 dark:text-gray-300" />
          </div>
          <div className="text-white">
            <h1 className="text-3xl font-bold">{profileData.name}</h1>
            <p className="text-blue-100 dark:text-blue-200 text-lg capitalize">
        ...
        <div className="flex items-center space-x-3">
          {!isEditing ? (
            <button
              onClick={handleEdit}
              className="flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-lg hover:from-blue-700 hover:to-purple-700 transition-colors"
            >
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <div className="flex-1">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  ) : (
              ...
              {/* DOB */}
              <div className="flex items-start space-x-3">
                <Calendar className="h-5 w-5 text-gray-400 dark:text-gray-500 mt-1" />
                <div className="flex-1">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {/* Department */}
              <div className="flex items-start space-x-3">
                <BookOpen className="h-5 w-5 text-gray-400 dark:text-gray-500 mt-1" />
                <div className="flex-1">
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 dark:text-gray-100">{profileData.department}</p>
                  )}
                </div>
              </div>
              ...
              {/* Qualifications */}
              <div className="flex items-start space-x-3">
                <Award className="h-5 w-5 text-gray-400 dark:text-gray-500 mt-1" />
                <div className="flex-1">
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 dark:text-gray-100">{profileData.qualifications}</p>
                  )}
                </div>
              </div>
              ...
              {/* Subjects */}
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Subjects Teaching</label>
                {isEditing ? (
                  <input
                    type="text"
                    value={editData.subjects.join(", ")}
                    onChange={(e) =>
                      handleInputChange("subjects", e.target.value.split(", ").map((s) => s.trim()))
                    }
        ...
        {/* Bio Section */}
        <div className="mt-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-700 pb-2 mb-4">
            About Me
          </h2>
          {isEditing ? (
            <textarea
